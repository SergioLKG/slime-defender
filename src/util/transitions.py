    ...
    if transition != False:
        ...
        if time_ratio > 1.0:
            ...
            if transition == "fadeOutUp":
                ...
                transition_data.current_screen = pygame.transform.smoothscale(transition_data.screen,
                                                                              [int(rect1[2] * (1 + time_ratio)),
                                                                               int(rect1[3] * (1 + time_ratio))])
                transition_data.current_screen = pygame.transform.rotate(transition_data.current_screen,
                                                                         10 * time_ratio)
